const data = {
  ...
  for (let i = 10; i < data.events.length; i++) {

    plantilla += `                
                    <div class="col-md-3">
                      <div class="card">
                        <img src="${data.events[i].image}" class="card-img-top" alt="..." height=200px>
                        <div class="card-body">
                          <h5>${data.events[i].name}</h5>
                          <p class="card-text">${data.events[i].description}</p>
                          <a href="./details.html" class="btn btn-danger">Go somewhere</a>
                        </div>
                      </div>
                    </div>               
                `
  ...
  const eventosDiv = document.getElementById('eventosPasados');
eventosDiv.innerHTML = plantilla;